...
.method private buildLegacyExtrasBundle()Landroid/os/PersistableBundle;
    ...
    iget-object v3, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mLocusId:Landroidx/core/content/LocusIdCompat;

    invoke-virtual {v3}, Landroidx/core/content/LocusIdCompat;->getId()Ljava/lang/String;
    ...
    iget-boolean v3, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIsLongLived:Z
...
.method static fromShortcuts(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v3, p0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$Builder;-><init>(Landroid/content/Context;Landroid/content/pm/ShortcutInfo;)V
...
.method static getPersonsFromExtra(Landroid/os/PersistableBundle;)[Landroidx/core/app/Person;
    ...
    .line 342
    .local v2, "personsLength":I
    new-array v1, v2, [Landroidx/core/app/Person;
...
.method public toShortcutInfo()Landroid/content/pm/ShortcutInfo;
    ...
    iget-object v4, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mContext:Landroid/content/Context;
    ...
    iget-object v3, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIcon:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-virtual {v0, v3}, Landroid/content/pm/ShortcutInfo$Builder;->setIcon(Landroid/graphics/drawable/Icon;)Landroid/content/pm/ShortcutInfo$Builder;

    .line 114
    :cond_0
    iget-object v3, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mLongLabel:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v3}, Landroid/content/pm/ShortcutInfo$Builder;->setLongLabel(Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;

    .line 117
    :cond_1
    iget-object v3, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mDisabledMessage:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v3}, Landroid/content/pm/ShortcutInfo$Builder;->setDisabledMessage(Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;

    .line 120
    :cond_2
    iget-object v3, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mActivity:Landroid/content/ComponentName;
    ...
    invoke-virtual {v0, v3}, Landroid/content/pm/ShortcutInfo$Builder;->setActivity(Landroid/content/ComponentName;)Landroid/content/pm/ShortcutInfo$Builder;

    .line 123
    :cond_3
    iget-object v3, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mCategories:Ljava/util/Set;
    ...
    invoke-virtual {v0, v3}, Landroid/content/pm/ShortcutInfo$Builder;->setCategories(Ljava/util/Set;)Landroid/content/pm/ShortcutInfo$Builder;

    .line 126
    :cond_4
    iget v3, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mRank:I
    ...
    invoke-virtual {v0, v3}, Landroid/content/pm/ShortcutInfo$Builder;->setExtras(Landroid/os/PersistableBundle;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    new-array v2, v3, [Landroid/app/Person;

    .line 133
    .local v2, "persons":[Landroid/app/Person;
    const/4 v1, 0x0
    ...
    .line 138
    .end local v1    # "i":I
    .end local v2    # "persons":[Landroid/app/Person;
    :cond_7
    iget-object v3, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mLocusId:Landroidx/core/content/LocusIdCompat;
    ...
    invoke-virtual {v0, v3}, Landroid/content/pm/ShortcutInfo$Builder;->setLocusId(Landroid/content/LocusId;)Landroid/content/pm/ShortcutInfo$Builder;
